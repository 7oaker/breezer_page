---
title: "Snus Tracker: tracken ohne aufhören zu müssen | Breezer"
heading: "Snus Tracker: wissen statt schätzen"
description: "Ein Snus Tracker für alle, die ihren Konsum kennen wollen, ohne sofort aufzuhören. Was sichtbar wird, was Tracking belegbar leistet und was nicht."
...
faq:
  - q: "Was ist ein Snus Tracker?"
    a: "Eine App, die jede konsumierte Portion festhält und daraus Tages-, Wochen- und Monatswerte bildet. Der Zweck ist nicht Erziehung, sondern eine Zahl: fast niemand kennt seinen tatsächlichen Verbrauch, weil Beutel in Lücken konsumiert werden und nicht zu festen Zeiten."
  - q: "Muss ich aufhören wollen, um einen Tracker zu nutzen?"
    a: "Nein, und das ist der Unterschied zu den meisten Apps in diesem Bereich. Klassische Quit-Apps setzen einen Ausstiegswunsch voraus und rechnen ab Tag eins snusfreie Tage. Breezer startet beim Tracken. Ob daraus Reduzieren oder Aufhören wird, entscheidest du später oder nie."
  - q: "Bringt Tracking mit einer App nachweislich etwas?"
  ...
  - q: "Was sehe ich nach zwei Wochen Tracken?"
    a: "Drei Dinge, die vorher unsichtbar waren: den tatsächlichen Tagesschnitt gegenüber deiner Schätzung, die Tageszeiten mit den Häufungen, und die Kosten hochgerechnet aufs Jahr. Die Tagesverteilung ist meist der aufschlussreichste Teil, weil sie die Auslöser zeigt."
  - q: "Funktioniert der Tracker auch für Zyn und Velo?"
    a: "Ja, Breezer ist markenunabhängig. Zyn, Velo, LOOP, XQS, Killa, Pablo und klassischer Snus landen im selben Zähler. Markenspezifische Details stehen auf der Zyn Tracker Seite."
...
heroImageAlt: Breezer Snus Tracker mit wöchentlichen Statistiken und Ausgaben
gallery:
  - image: ../../../assets/images/screens/new/take-snus.png
    alt: Snus mit einem Tipp in Breezer loggen
    caption: Ein Tipp pro Beutel
  - image: ../../../assets/images/screens/new/snus-ranking.png
    alt: Globale Snus-Rangliste in der Breezer App
    caption: Vergleich weltweit
---
...
In Breezer ist Tracking der Ausgangszustand. [Der Quit-Modus](/de/snus-aufhoeren) liegt daneben und wird eingeschaltet, wenn du so weit bist. Oder nie.

## Was Tracking belegbar leistet, und was nicht

Die ehrliche Einordnung gehört auf jede Seite, die eine App anbietet. Der Cochrane-Review [Mobile phone text messaging and app-based interventions for smoking cessation](https://www.cochrane.org/evidence/CD006611_can-programmes-delivered-mobile-phones-help-people-stop-smoking) von Robyn Whittaker und Kollegen (2019) prüfte, ob Handy-Programme die Ausstiegsquote heben.
...
Was ein Tracker trotzdem nicht ist: ein Behandlungsversprechen. Er ist ein Messinstrument, das dir den Ausgangswert verschafft, ohne den weder ein Limit noch ein Fortschritt existiert. Was beim Aufhören am stärksten belegt ist, steht mit allen Zahlen auf [Snus aufhören](/de/snus-aufhoeren), und das ist Beratung.
...
Wenn du markenspezifisch einsteigen willst, etwa weil die Stärkeangabe auf der Dose unklar ist, führt die [Zyn Tracker Seite](/de/zyn-tracker) genauer durch die Einheiten. Wie viel Nikotin überhaupt im Blut ankommt, steht in [wie stark ein Nikotinbeutel wirklich ist](/de/blog/nikotinbeutel-staerke). Und wenn dich der Gesundheitsteil hierher gebracht hat, ist [was Nikotinbeutel mit dem Zahnfleisch machen](/de/blog/nikotinbeutel-zahnfleisch) die ehrliche Bestandsaufnahme der Datenlage.
