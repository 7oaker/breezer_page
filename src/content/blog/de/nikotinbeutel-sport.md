---
title: "Snus und Sport: was die Forschung wirklich zeigt"
heading: "Bringen Nikotinbeutel im Sport etwas?"
description: "Nikotin ist im Sport nicht verboten, und jeder fünfte Profifußballer nutzt Beutel. Was kontrollierte Studien zu Leistung, Fokus und Abhängigkeit tatsächlich gefunden haben."
...
faq:
  - q: "Ist Nikotin im Sport verboten?"
    a: "Nein. Nikotin steht nicht auf der Verbotsliste der Welt-Anti-Doping-Agentur. Es steht auf dem Monitoring-Programm, wo WADA den Gebrauch im Wettkampf als Stimulans beobachtet, um Missbrauchsmuster zu erkennen. Der Konsum ist kein Verstoß und wird nicht sanktioniert."
  - q: "Verbessern Nikotinbeutel die sportliche Leistung?"
    a: "Die Evidenz sagt überwiegend nein. Über Studien zu Maximalkraft, Ausdauer und hochintensiver Belastung hinweg fand die große Mehrheit keine Veränderung der Leistung. Eine Minderheit fand kleine positive Effekte, mindestens eine einen negativen."
  - q: "Warum nutzen dann so viele Sportler Snus?"
    a: "Die Spieler nennen Fokus und Entspannung nach dem Training, nicht Leistungssteigerung. Die Studie von PFA und Loughborough fand, dass rund jeder fünfte Profifußballer in England Beutel nutzt und die Mehrheit dieser Nutzer Anzeichen von Nikotinabhängigkeit zeigt."
  - q: "Beeinflusst Nikotin Regeneration und Schlaf?"
    a: "Nikotin ist ein Stimulans, und gestörter Schlaf gehört zu den am häufigsten berichteten Effekten, sowohl beim Konsum als auch im Entzug. Da Anpassung im Schlaf passiert, ist das der Punkt mit dem klarsten Nachteil für jeden, der ernsthaft trainiert."
  - q: "Lohnt sich ein Beutel vor dem Spiel oder Training?"
    a: "Es gibt keine belastbare Evidenz für einen Leistungsvorteil, auf den man eine Routine bauen könnte, und ein gut dokumentiertes Abhängigkeitsrisiko. Wenn du ohnehin konsumierst, ist die nützlichere Frage wie viele pro Tag, nicht wann."
---
...
Nein. Nikotin steht **nicht** auf der Verbotsliste der Welt-Anti-Doping-Agentur. Es steht auf dem [Monitoring-Programm](https://www.wada-ama.org/en/resources/monitoring-program) der WADA, wo der Gebrauch im Wettkampf als Stimulans beobachtet wird, um Missbrauchsmuster zu erkennen. Substanzen auf diesem Programm sind nicht verboten, ihr Konsum ist kein Verstoß gegen Anti-Doping-Bestimmungen, und es gibt keine Sanktion.
...
Das ist der Teil, der das Bild verändert. Die Professional Footballers' Association und die [Loughborough University](https://www.lboro.ac.uk/news-events/news/2024/may/snus-study-findings-published/) befragten 628 Profis im Männer- und 51 im Frauenfußball in England, dazu Interviews mit 16 Personen aus Leistungs- und Medizinabteilungen der Klubs. Veröffentlicht wurde das im *Journal of Science and Medicine in Sport*.

| Befund | Männer | Frauen |
| --- | --- | --- |
| Nutzen aktuell Snus oder Nikotinbeutel | 18 % | 22 % |
| Davon mit Anzeichen von Nikotinabhängigkeit | 53 % | 73 % |
...
Breezer loggt jeden Beutel mit einem Tipp und zeigt das Tages- und Wochenmuster, inklusive des Teils, den die meisten unterschätzen: wie viel davon sich um Training und Spiele herum ballt. Wenn die Zahl höher ist als gedacht, setzt du im [Snus Tracker](/de/snus-tracker) ein Tageslimit. Wenn du lieber ganz aufhören willst, übernimmt der [Quit-Modus](/de/snus-aufhoeren) mit Entzugsverlauf und dem, was in den ersten zehn Tagen zu erwarten ist.

Und bevor du Marken vergleichst: die Stärke auf der Dose ist oft nicht die Dosis. Das steht in [wie stark ein Nikotinbeutel wirklich ist](/de/blog/nikotinbeutel-staerke). Wenn dich weniger das Training als der Mund beschäftigt, geht [was Nikotinbeutel mit dem Zahnfleisch machen](/de/blog/nikotinbeutel-zahnfleisch) die Evidenz durch.
