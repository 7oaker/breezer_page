...
export const homeFaq: Record<Locale, QA[]> = {
  ...
  { q: "What is Breezer?", a: "Breezer is a free social snus app for iOS and Android. It lets you track snus consumption, compete with friends on global leaderboards, earn rewards, and quit snus with a guided Quit Mode." },
    ...
    { q: "Is Breezer free?", a: "Yes. Tracking, friends, rankings, the global chat and Quit Mode all work without paying. Breezer Pro adds depth on top for €2.99 a month or €19.99 a year, with one free week. What is free and what Pro adds is listed on the pricing page." },
  ...
  { q: "Was ist Breezer?", a: "Breezer ist eine kostenlose soziale Snus App f\u00fcr iOS und Android. Du kannst deinen Snus-Konsum tracken, mit Freunden auf globalen Ranglisten antreten, Rewards sammeln und mit dem Quit-Modus Schritt f\u00fcr Schritt aufh\u00f6ren." },
    ...
    { q: "Ist Breezer kostenlos?", a: "Ja. Tracken, Freunde, Ranglisten, der globale Chat und der Quit-Modus funktionieren ohne Bezahlung. Breezer Pro gibt Tiefe dazu, f\u00fcr 2,99 \u20ac im Monat oder 19,99 \u20ac im Jahr, mit einer Gratiswoche. Was gratis ist und was Pro dazugibt, steht auf der Preisseite." },
  ...
  sv: [
    ...
    { q: "Är Breezer gratis?", a: "Ja. Tracking, vänner, topplistor, chatten och Quit-läget fungerar utan att betala. Breezer Pro lägger till djupet ovanpå för 2,99 € i månaden eller 19,99 € per år, med en gratis vecka." },
