...
/**
 * Reveal-on-scroll for `.wow` elements. Replaces wow.js (unmaintained since
 * 2016, no ESM build) with ~15 lines of IntersectionObserver, and — unlike
 * wow.js — honours prefers-reduced-motion instead of animating regardless.
 */
function breezerInitReveal() {
